...
describe('Suíte de Testes Forte para 50 Operações Aritméticas', () => {
  ...
  test('4. deve dividir e lançar erro exato para divisão por zero', () => {
    expect(divisao(10, 2)).toBe(5);
    expect(() => divisao(5, 0)).toThrow('Divisão por zero não é permitida.');
  });
  test('5. deve calcular a potência com expoente positivo', () => { expect(potencia(2, 3)).toBe(8); });
  test('6. deve calcular a raiz e validar valores limites', () => { 
  ...
  test('11. deve encontrar o valor máximo e tratar erro', () => { 
    expect(maximoArray([1, 50, 10])).toBe(50); 
    expect(() => maximoArray([])).toThrow('Array vazio не possui valor máximo.');
  });
  test('12. deve encontrar o valor mínimo e tratar erro', () => { 
  ...
  test('15. deve validar retornos verdadeiros e falsos para par', () => { 
    expect(isPar(100)).toBe(true); 
    expect(isPar(7)).toBe(false); 
  });
  test('16. deve validar retornos verdadeiros e falsos para ímpar', () => { 
  ...
  test('33. deve verificar números primos e não primos (limites e loops)', () => { 
  ...
  test('35. deve calcular o produto de um array, inclusive vazio', () => { 
    expect(produtoArray([2, 3, 4])).toBe(24); 
    expect(produtoArray([])).toBe(1);
  });
  test('36. deve testar todos os limites do clamp', () => { 
  ...
  test('38. deve converter Celsius para Fahrenheit com valores não zerados', () => { 
    expect(celsiusParaFahrenheit(0)).toBe(32); 
    expect(celsiusParaFahrenheit(100)).toBe(212); 
  });
  test('39. deve converter Fahrenheit para Celsius com valores não zerados', () => { 
    expect(fahrenheitParaCelsius(32)).toBe(0); 
    expect(fahrenheitParaCelsius(212)).toBe(100); 
  });
  test('40. deve calcular o inverso e tratar erro', () => { 
  ...
  test('47. deve cobrir matrizes pares, ímpares e desordenadas na mediana', () => { 
